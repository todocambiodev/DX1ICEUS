...
if __name__ == "__main__":
    ...
    SYMBOL: str = "DXY"
    EXCHANGE: str = "TVC"
    URL_ENVIAR_DATOS: str = "https://script.google.com/macros/s/AKfycbxwkG2nlESGa_ZCPttN2WRbE0zi6_8lr0MBlcOX2uSGm9PW6NJTk_Rskqy1hiUeQnVC6A/exec"
    URL_DISPARAR_GITHUB_ACTIONS: str = "https://script.google.com/macros/s/AKfycbxwkG2nlESGa_ZCPttN2WRbE0zi6_8lr0MBlcOX2uSGm9PW6NJTk_Rskqy1hiUeQnVC6A/exec"
    CICLO_FINAL: int = 63
    # -------------------
